...
public class TestVoyante {
  ...
  public void test2() {
    ...
    System.out.println("");
    System.out.print("Main de la voyante (" + voyante.getJoueur().getNom() +
        "): ");
    ...
    Test.test(marchande.getJoueur().nbQuartiersDansMain() == 0,
        "On verifie que la marchande a bien le même nombre carte à la fin");
    Test.test(roi.getJoueur().nbQuartiersDansMain() == 3,
        "On verifie que le roi a bien le même nombre carte à la fin");
    Test.test(assassin.getJoueur().nbQuartiersDansMain() == 3,
        "On verifie que l'assassin a bien le même nombre carte à la fin");
    Test.test(voyante.getJoueur().nbQuartiersDansMain() == 2,
        "On verifie que la voyante a bin le même nombre carte à la fin");
