  ...
  public class TestEmpereur {
    ...
    public void test1() {
        ...
        Test.test(empereur.getJoueur() == null,
                "test de l'initialisation de la variable \"joueur\"");
        Test.test(empereur.getAssassine() == false,
                "test de l'initialisation de la variable \"assassine\"");
        Test.test(empereur.getVole() == false,
    ...
    public void test2() {
        ...
        empereur.setPlateau(plateau);
        roi.setPlateau(plateau);
        assassin.setPlateau(plateau);
        ...
        Test.test(empereur.getJoueur().nbPieces() == 0,
                "Nombre de piece avant perception");
        empereur.percevoirRessourcesSpecifiques();
        Test.test(empereur.getJoueur().nbPieces() == 2,
                "Nombre de piece apres ressource specifique");
        ...
        Test.test(empereur.getJoueur().nbPieces() == 3,
                "Test l'assassin donne de l'or");
        Test.test(empereur.getJoueur().nbQuartiersDansMain() == 1,
                "Test l'assassin donne une carte");
    }

    public void test3() {
        System.out.
                println("TEST PERCEPTION DES RESSOURCES ET POUVOIR SUR UNE PERSONNE QUI N AS NI OR NI CARTE"
                );
        PlateauDeJeu plateau = new PlateauDeJeu();
        Joueur joueur = new Joueur("Billy");
        plateau.ajouterJoueur(joueur);
        ...
        Test.test(empereur.getJoueur().nbPieces() == 0,
                "Test l'assassin donne de l'or");
        Test.test(empereur.getJoueur().nbQuartiersDansMain() == 0,
                "Test l'assassin donne une carte");
    }

    public void test4() {
        System.out.
                println("TEST PERCEPTION DES RESSOURCES ET POUVOIR APRES ASSASSINAT");
        PlateauDeJeu plateau = new PlateauDeJeu();
        Joueur joueur = new Joueur("Billy");
        plateau.ajouterJoueur(joueur);
        Joueur joueur2 = new Joueur("Martin");
        ...
        Test.test(empereur.getJoueur().nbQuartiersDansMain() == 0,
                "Test l'assassin donne une carte");
    } // je sais pas comment ça fonctionne voir avec la fonction de matthieu
}