...
public class TestDiplomate {
    ...
    public void test2() {
        ...
        if (diplomate.getJoueur().quartierPresentDansCite("temple")) {
            ...
            Test.test(roi.getJoueur().nbQuartiersDansCite() == 5, "nombre de quartier chez le roi apres l'echange");
            ...
            Test.test(roi.getJoueur().nbQuartiersDansCite() == 5, "nombre de quartier chez le roi apres l'echage");
            Test.test(roi.getJoueur().nbPieces() == 0,
            ...
            Test.test(roi.getJoueur().nbQuartiersDansCite() == 5, "nombre de quartier chez le roi apres vole");
    ...
    public void test5() {
        ...
        Test.test(diplomate.getJoueur().nbPieces() == 2, "nombre de piece du diplomate apres pouvoir sans quartier");
        Test.test(roi.getJoueur().nbQuartiersDansCite() == 1,
