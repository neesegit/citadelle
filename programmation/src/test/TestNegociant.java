...
public class TestNegociant {
    ...
    public void test1() {
        ...
        Test.test(negociant.getNom().equals("Negociant"), "test du nom du personnage");
        ...
        Test.test(negociant.getJoueur() == null, "test de l'initialisation de la variable \"joueur\"");
        Test.test(negociant.getAssassine() == false, "test de l'initialisation de la variable \"assassine\"");
        Test.test(negociant.getVole() == false, "test de l'initialisation de la variable \"vole\"");
    }
    ...
    public void test2() {
        ...
        Test.test(negociant.getJoueur().nbQuartiersDansCite() == 0, "Verification nombre de quartier dans la cité");
