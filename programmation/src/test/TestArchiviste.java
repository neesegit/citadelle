...
public class TestArchiviste {
    ...
    public void test2() {
        ...
        pioche.ajouter(q);
        pioche.melanger();
        Test.test(archiviste.getJoueur().nbQuartiersDansMain() == 0, "Test du nombre de carte dans la main");
        archiviste.utiliserPouvoir();
        // verifier que j'ai bien le choix entre 7 carte quartier
        Test.test(archiviste.getJoueur().nbQuartiersDansMain() == 1, "Test du nombre de carte dans la main");
        ...
        Test.test(archiviste.getJoueur().nbQuartiersDansCite() == 2, "Test de la double construction");// Overwrite la
                                                                                                       // onction
                                                                                                       // construire
    }
