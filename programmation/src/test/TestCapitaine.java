...
public class TestCapitaine {
    ...
    public void test1() {
        ...
        Test.test(capitaine.getNom().equals("Capitaine"), "test du nom du personnage");
        ...
        Test.test(capitaine.getJoueur() == null, "test de l'initialisation de la variable \"joueur\"");
        Test.test(capitaine.getAssassine() == false, "test de l'initialisation de la variable \"assassine\"");
        Test.test(capitaine.getVole() == false, "test de l'initialisation de la variable \"vole\"");
    }
    ...
    public void test3() {
        ...
        Quartier quartier1 = new Quartier("temple", Quartier.TYPE_QUARTIERS[0], 1);
        roi.getJoueur().ajouterQuartierDansCite(quartier1);
        Test.test(roi.getJoueur().nbQuartiersDansCite() == 1, "nombre de quartier chez le roi avant de commencer");
        Test.test(capitaine.getJoueur().nbQuartiersDansCite() == 0,
                "nombre de quartier chez la capitaine avant de commencer");
        Test.test(capitaine.getJoueur().nbPieces() == 0, "nombre de piece de la capitaine avant de commencer");
        capitaine.percevoirRessourcesSpecifiques();
